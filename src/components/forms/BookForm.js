...
class BookForm extends React.Component   //this data is same as proptype book defined in the last of this page--coming from server
{  state = {    data: {     goodreadsId: this.props.book.goodreadsId,
                            title: this.props.book.title,  authors: this.props.book.authors,
                            cover: this.props.book.covers[0], pages: this.props.book.pages
                     },
  ...
  componentWillReceiveProps(props) //----called everytime --books are changed---else nothing will happen--only one book will show 
   {  this.setState(
       {  data: {   goodreadsId: props.book.goodreadsId,
                    title: props.book.title,  authors: props.book.authors,
                    cover: props.book.covers[0],  pages: props.book.pages
                },
      ...
      <Segment>
        <Form onSubmit={this.onSubmit} loading={loading}>
          <Grid columns={2} stackable>
            ...
            <Grid.Row> <Button primary>Save</Button> </Grid.Row> </Grid>
        </Form>
      </Segment>
    );
  }
